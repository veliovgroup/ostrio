_app.i18n.en.forgot = 
  ...
  success: 'Boris have sent you confirmation email, please check your inbox.'
  errors:
    '403': 'Verification link is already sent, please check your email. Or try again in few hours.'
  annotation:
    email: 'Enter your email-address, Boris will send you a letter with further instructions'
  check:

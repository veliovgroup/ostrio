_app.i18n.en.promo = 
  image:
    caption: 'Boris - Your personal server and websites guard'
  lead:
    main: 
  ...
  crc:
    ...
    text: 'With Boris you will be notified about any changes in SSL-certificate, IP-address, DNS records and Whois information. Boris will remind you about coming expiration dates of domain and SSL-certificates. Boris runs CRC checks over most sensitive data, and any data you would like to keep solid.'
  join:
    text: 'More than {{usersQty}} developers, DevOps and production studios adopted Boris for their needs. Join them now, for faster and safer web without downtime!'

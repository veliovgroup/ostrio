_app.i18n.en.notifications = 
  ...
  beta:
    feedback:
      received:
        subject: 'Boris: Thank you for your feedback!'
  ...
  sms:
    lowCredit:
      title: 'Low credit'
      subject: email: '<strong>Boris Guard:</strong> Low credit for SMS'
      message: email: '<p>You have credit for not more than {{smss}} SMS. To keep receiving SMS form Boris - please add more credit.</p>'

  endpoint: 
    in:
      title: 'Endpoint monitoring warning: "{{property}}"'
      subject: email: '<strong>Boris Guard:</strong> Endpoint {{address}} warning for "{{property}}"'
      message: 
    ...
    out:
      ...
      subject: email: '<strong>Boris Guard:</strong> Endpoint {{address}} value "{{property}}", is went to normal state'
      message: 
    ...
    change:
      ...
      subject: email: '<strong>Boris Guard:</strong> Endpoint {{address}} value "{{property}}" is changed'
      message: 
  ...
  server:
    endOfPaid:
      ...
      subject: email: '<strong>Boris Guard:</strong> "Paid" subscription is ended for {{address}}'
    ...
    serverWillBeRenewed:
      ...
      subject: email: '<strong>Boris Guard:</strong> "Paid" subscription will be renewed {{expireAt}}'
    ...
    lowCreditForServer:
      ...
      subject: email: '<strong>Boris Guard:</strong> "Paid" subscription will end {{expireAt}}'
    ...
    paidRenewed:
      ...
      subject: email: '<strong>Boris Guard:</strong> "Paid" subscription is renewed for {{address}}'
      message: email: '<p>Paid subscription is renewed for <strong>{{address}}</strong> for one more month.</p>'
    lowCreditNextMonth:
      title: 'Low credit'
      subject: email: '<strong>Boris Guard:</strong> Low credit'
    ...
    DNS:
      changed:
        ...
        subject: email: '<strong>Boris Guard:</strong> DNS records is changed for {{address}}'
        message: 
    ...
    IP:
      changed:
        ...
        subject: email: '<strong>Boris Guard:</strong> IP-address is changed for {{address}}'
        message: 
    ...
    whois:
      changed:
        ...
        subject: email: '<strong>Boris Guard:</strong> whois is changed for {{address}}'
        message: 
    ...
    ssl:
      changed:
        ...
        subject: email: '<strong>Boris Guard:</strong> SSL certificate is changed for {{address}}'
        message: 
      ...
      expiresSoon:
        ...
        subject: email: '<strong>Boris Guard:</strong> {{address}} SSL certificate will expire at {{expiresAt}}'
        message: 
    ...
    domainExpires:
      ...
      subject: email: '<strong>Boris Guard:</strong> {{address}} will expire at {{expiresAt}}'
      message: 
          email: '<p>Domain: <strong>{{address}}</strong> will expire at {{expiresAt}}.</p>'
          phone: 'Domain: {{address}}. Will expire at {{expiresAt}}'
    verified:
      title: 'Successfully confirmed'
      subject: email: '<strong>Boris Guard:</strong> {{address}} is added'
    ...
    unverified:
      ...
      subject: email: '<strong>Boris Guard:</strong> {{address}} verification code is not detected'
      message: email: '<p>Server <strong>{{address}}</strong> is not watched anymore by Boris.</p><p>Please re-verify this server as soon as possible.</p>'
  user:
    signup: 
      subject: email: 'Welcome to <strong>Boris Guard</strong>'
      message: email: '<p>Thank you for registration, you\'ve received this email as confirmation of successful registration.</p><p>Your login is: <strong>{{login}}</strong></p><p>Your password is: <strong>{{password}}</strong></p><p><em>Do not forget to confirm this email-address, see second email from Boris</em></p>'
    confirmEmail:
      subject: email: '<strong>Boris Guard:</strong> Confirm this email-address'
      message: email: "<p>Please confirm this email address by following <a href=\"{{link}}\">this link</a></p><p><small>If link above doesn't work, copy and pase url to your browser: {{link}}</small></p>"
    forgot:
      confirm:
        subject: email: '<strong>Boris Guard:</strong> Confirm Password Recovery'
      ...
      recovery:
        subject: email: '<strong>Boris Guard:</strong> Password recovery'

...
This guide explains how to enable [ostr.io pre-rendering SEO MIddleware](https://github.com/veliovgroup/ostrio/blob/master/docs/prerendering/README.md) for sites deployed on Netlify.
